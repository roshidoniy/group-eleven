...
export const courses: Course[] = [
  ...
  },
  {
    ...
    time: { hour: 16, min: 50, weekday: "Monday" },
    lab: {
      ...
      time: { hour: 19, min: 0, weekday: "Monday" },
    },
  },
  {
    id: "3",
    ...
    time: { hour: 8, min: 0, weekday: "Thursday" },
    lab: {
      ...
      time: { hour: 16, min: 50, weekday: "Tuesday" },
    },
  },
  {
    id: "4",
    ...
    time: { hour: 8, min: 0, weekday: "Tuesday" },
    lab: {
      ...
      time: { hour: 19, min: 0, weekday: "Tuesday" },
    },
  },
  {
    id: "5",
  ...
  },
  {
    ...
    time: { hour: 10, min: 10, weekday: "Friday" },
  },
];