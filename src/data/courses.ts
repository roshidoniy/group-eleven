...
export const courses: Course[] = [
  {
    ...
    time: { hour: 9, min: 0, weekday: "Monday" },
    lab: {
  ...
  },
  {
    ...
    time: { hour: 14, min: 0, weekday: "Monday" },
    lab: {
      ...
      time: { hour: 16, min: 0, weekday: "Monday" },
    },
  },
  {
    id: "3",
    ...
    time: { hour: 10, min: 0, weekday: "Friday" },
    lab: {
      ...
      time: { hour: 13, min: 0, weekday: "Friday" },
    },
  },
  {
    id: "4",
