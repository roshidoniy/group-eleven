export interface LabSession {
  ...
  time: {
    hour: number;
    min: number;
    weekdayNumber: number; // 0-6, where 0 is Monday
  };
}
...
export const courses: Course[] = [
  ...
  },
  {
    ...
    time: { hour: 16, min: 50, weekdayNumber: 0 },
    lab: {
      ...
      time: { hour: 19, min: 0, weekdayNumber: 0 },
    },
  },
  {
    id: "3",
    ...
    time: { hour: 8, min: 0, weekdayNumber: 3 },
    lab: {
  ...
  },
  {
    ...
    time: { hour: 12, min: 30, weekdayNumber: 3 },
    lab: {
